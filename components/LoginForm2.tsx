...
//import loginImg from '../public/images/rickandmorty.jpg'
...
function LoginForm2() {
        return (
            ...
            <div className='w-screen h-screen flex justify-end items-center  
                ...
                <form className='max-w-[400px] w-full rounded-xl bg-white p-10 drop-shadow-lg'>    
                    ...
                    <div className='flex justify-between py-8'>
                        <button onClick={() => signIn()} className='border shadow-lg hover:shadow-xl px-6 py-2 relative flex items-center'><GoMarkGithub className='mr-2' /> Github</button>
                        <button onClick={() => signIn()} className='border shadow-lg hover:shadow-xl px-6 py-2 relative flex items-center'><FcGoogle className='mr-2' /> Google</button>
                    </div>
